...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case constants.NEW_USER:
      ...
      return emailСomparison != action.payload.email ? Object.assign({}, state, {users: [...state.users, action.payload], userWithEmail: 'Successfully!'}) : Object.assign({}, state, {users: [...state.users], userWithEmail: 'This address is already busy!'}); // Object.assign({}, state, {users: [...state.users, action.payload]}) - записывает в массив стейта не ломая стейт (  authorized: false )
